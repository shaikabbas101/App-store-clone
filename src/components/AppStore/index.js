...
class AppStore extends Component {
  ...
  render() {
    ...
    const searchResults = filteredData.filter(eachData =>
      eachData.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )
    ...
    return (
      <div className="bg-container">
        <div className="app-container">
          ...
          <div className="img-and-icon-container">
            <input
              type="search"
              placeholder="search"
          ...
          <ul className="tabs-container">
            {tabsList.map(eachTab => (
              <TabItem
                key={eachTab.tabId}
                selectTab={this.updateSelectedTab}
                tabItem={eachTab}
                isActiveTab={eachTab.tabId === selectedTab}
              />
            ))}
          </ul>
          ...
          <ul className="app-list-container">
            {searchResults.map(eachData => (
              <AppItem key={eachData.appId} data={eachData} />
            ))}
          </ul>
        </div>
      </div>
